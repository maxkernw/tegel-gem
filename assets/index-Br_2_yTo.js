            ...
            ${e.days.map(h=>`
                <div class="day-cell ${h.date===s?"today":""}" data-date="${h.date}">
                    ...
                    <div class="event-list">
                        ${h.events.map(d=>{var T;const f=d.userId===((T=xe.currentUser)==null?void 0:T.uid),_=new Date(d.start).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),m=new Date(d.end).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`

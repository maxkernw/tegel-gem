 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f=function(n,e){if(!n)throw Xe(e)},Xe=function(n){return new Error("Firebase Database ("+Lr.SDK_VERSION+") INTERNAL ASSERT FAILED: "+n)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl=1024,Rl=720*60*60*1e3;class Nl{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new kl(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){var e,t;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=As();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r)?void 0:(this._heartbeatsCache.heartbeats.push({date:r,agent:s}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const a=new Date(o.date).valueOf();return Date.now()-a<=Rl}),this._storage.overwrite(this._heartbeatsCache))}catch(i){ie.warn(i)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=As(),{heartbeatsToSend:i,unsentEntries:s}=Al(this._heartbeatsCache.heartbeats),r=Yt(JSON.stringify({version:2,heartbeats:i}));return this._heartbeatsCache.lastSentHeartbeatDate=t,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return ie.warn(t),""}}}function As(){return new Date().toISOString().substring(0,10)}function Al(n,e=bl){const t=[];let i=n.slice();for(const s of n){const r=t.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),ks(t)>e){r.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),ks(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class kl{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fc()?pc().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Sl(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Ns(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const s=await this.read();return Ns(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function ks(n){return Yt(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pl(n){je(new Ae("platform-logger",e=>new qc(e),"PRIVATE")),je(new Ae("heartbeat",e=>new Nl(e),"PRIVATE")),_e(Zn,bs,n),_e(Zn,bs,"esm2017"),_e("fire-js","")}Pl("");var Ol="firebase",Dl="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const en=new wi("@firebase/auth");function Ml(n,...e){en.logLevel<=w.WARN&&en.warn(`Auth (${et}): ${n}`,...e)}function qt(n,...e){en.logLevel<=w.ERROR&&en.error(`Auth (${et}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Kl(n,e=!1){const t=x(n),i=await t.getIdToken(e),s=Ai(i);m(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const r=typeof s.firebase=="object"?s.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:ft(Vn(s.auth_time)),issuedAtTime:ft(Vn(s.iat)),expirationTime:ft(Vn(s.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function Vn(n){return Number(n)*1e3}function Ai(n){const[e,t,i]=n.split(".");if(e===void 0||t===void 0||i===void 0)return qt("JWT malformed, contained fewer than 3 sections"),null;try{const s=Jt(t);return s?JSON.parse(s):(qt("Failed to decode base64 JWT payload"),null)}catch(s){return qt("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Ds(n){const e=Ai(n);return m(e,"internal-error"),m(typeof e.exp<"u","internal-error"),m(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yh(n,e){return Tn(n,"POST","/v1/accounts:signInWithPassword",Me(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eh(n,e){return Tn(n,"POST","/v1/accounts:signInWithEmailLink",Me(n,e))}async function Ih(n,e){return Tn(n,"POST","/v1/accounts:signInWithEmailLink",Me(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wh(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Ch(n){const e=ut(dt(n)).link,t=e?ut(dt(e)).deep_link_id:null,i=ut(dt(n)).deep_link_id;return(i?ut(dt(i)).link:null)||i||t||e||n}class Oi{constructor(e){var t,i,s,r,o,a;const c=ut(dt(e)),l=(t=c.apiKey)!==null&&t!==void 0?t:null,u=(i=c.oobCode)!==null&&i!==void 0?i:null,h=wh((s=c.mode)!==null&&s!==void 0?s:null);m(l&&u&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=u,this.continueUrl=(r=c.continueUrl)!==null&&r!==void 0?r:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const t=Ch(e);try{return new Oi(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nt{constructor(){this.providerId=nt.PROVIDER_ID}static credential(e,t){return Tt._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const i=Oi.parseLink(t);return m(i,"argument-error"),Tt._fromEmailAndCode(e,i.code,i.tenantId)}}nt.PROVIDER_ID="password";nt.EMAIL_PASSWORD_SIGN_IN_METHOD="password";nt.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nh(n){const e=tt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}function Ah(n,e,t){return Q(n.app)?Promise.reject(me(n)):Rh(x(n),nt.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Nh(n),i})}function kh(n,e,t,i){return x(n).onIdTokenChanged(e,t,i)}function Ph(n,e,t){return x(n).beforeAuthStateChanged(e,t)}function Oh(n,e,t,i){return x(n).onAuthStateChanged(e,t,i)}function Dh(n){return x(n).signOut()}const sn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Io extends yo{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Io.type="SESSION";const To=Io;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wo(){return typeof z().WorkerGlobalScope<"u"&&typeof z().importScripts=="function"}async function Bh(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Vh(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Hh(){return wo()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const au=600*1e3;class cu{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!lu(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!No(e)){const s=((i=e.error.code)===null||i===void 0?void 0:i.split("auth/")[1])||"internal-error";t.onError(j(this.auth,s))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=au&&this.cachedEventUids.clear(),this.cachedEventUids.has(qs(e))}saveEventToCache(e){this.cachedEventUids.add(qs(e)),this.lastProcessedEventTime=Date.now()}}function qs(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function No({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function lu(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return No(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vu=new Ot(5e3,15e3),yu="__/auth/iframe",Eu="emulator/auth/iframe",Iu={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Tu=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function wu(n){const e=n.config;m(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Ni(e,Eu):`https://${n.config.authDomain}/${yu}`,i={apiKey:e.apiKey,appName:n.name,v:et},s=Tu.get(n.config.apiHost);s&&(i.eid=s);const r=n._getFrameworks();return r.length&&(i.fw=r.join(",")),`${t}?${Ze(i).slice(1)}`}async function Cu(n){const e=await gu(n),t=z().gapi;return m(t,n,"internal-error"),e.open({where:document.body,url:wu(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Iu,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=j(n,"network-request-failed"),a=z().setTimeout(()=>{r(o)},vu.get());function c(){z().clearTimeout(a),s(i)}i.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Su={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},bu=500,Ru=600,Nu="_blank",Au="http://localhost";class Ks{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function ku(n,e,t,i=bu,s=Ru){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Su),{width:i.toString(),height:s.toString(),top:r,left:o}),l=M().toLowerCase();t&&(a=oo(l)?Nu:t),so(l)&&(e=e||Au,c.scrollbars="yes");const u=Object.entries(c).reduce((d,[p,_])=>`${d}${p}=${_},`,"");if(Zl(l)&&a!=="_self")return Pu(e||"",a),new Ks(null);const h=window.open(e||"",a,u);m(h,n,"popup-blocked");try{h.focus()}catch{}return new Ks(h)}function Pu(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wu(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Bu(n){je(new Ae("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),r=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;m(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:fo(n)},l=new rh(i,s,r,c);return ph(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),je(new Ae("auth-internal",e=>{const t=tt(e.getProvider("auth").getImmediate());return(i=>new Uu(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),_e(zs,Ys,Wu(n)),_e(zs,Ys,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class an extends Xo{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Ii()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new an}getInitialEvent(e){return f(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bn{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const i=new y(Ye,e),s=new y(Ye,t);return this.compare(i,s)!==0}minPost(){return y.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ai;function $d(n){ai=n}const sa=function(n){return typeof n=="number"?"number:"+Lo(n):"string:"+n},ra=function(n){if(n.isLeafNode()){const e=n.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&ae(e,".sv"),"Priority must be a string or number.")}else f(n===ai||n.isEmpty(),"priority of unexpected type.");f(n===ai||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd=Math.log(2);class Jd{constructor(e){const t=r=>parseInt(Math.log(r)/Yd,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const cn=function(n,e,t,i){n.sort(e);const s=function(c,l){const u=l-c;let h,d;if(u===0)return null;if(u===1)return h=n[c],d=t?t(h):h,new P(d,h.node,P.BLACK,null,null);{const p=parseInt(u/2,10)+c,_=s(c,p),I=s(p+1,l);return h=n[p],d=t?t(h):h,new P(d,h.node,P.BLACK,_,I)}},r=function(c){let l=null,u=null,h=n.length;const d=function(_,I){const N=h-_,Y=h;h-=_;const we=s(N+1,Y),Ce=n[N],Bt=t?t(Ce):Ce;p(new P(Bt,Ce.node,I,null,we))},p=function(_){l?(l.left=_,l=_):(u=_,l=_)};for(let _=0;_<c.count;++_){const I=c.nextBitIsOne(),N=Math.pow(2,c.count-(_+1));I?d(N,P.BLACK):(d(N,P.BLACK),d(N,P.RED))}return u},o=new Jd(n.length),a=r(o);return new U(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Kn;const Fe={};class te{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return f(Fe&&R,"ChildrenNode.ts has not been loaded"),Kn=Kn||new te({".priority":Fe},{".priority":R}),Kn}get(e){const t=Ke(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof U?t:null}hasIndex(e){return ae(this.indexSet_,e.toString())}addIndex(e,t){f(e!==qe,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const i=[];let s=!1;const r=t.getIterator(y.Wrap);let o=r.getNext();for(;o;)s=s||e.isDefinedOn(o.node),i.push(o),o=r.getNext();let a;s?a=cn(i,e.getCompare()):a=Fe;const c=e.toString(),l=Object.assign({},this.indexSet_);l[c]=e;const u=Object.assign({},this.indexes_);return u[c]=a,new te(u,l)}addToIndexes(e,t){const i=Qt(this.indexes_,(s,r)=>{const o=Ke(this.indexSet_,r);if(f(o,"Missing index implementation for "+r),s===Fe)if(o.isDefinedOn(e.node)){const a=[],c=t.getIterator(y.Wrap);let l=c.getNext();for(;l;)l.name!==e.name&&a.push(l),l=c.getNext();return a.push(e),cn(a,o.getCompare())}else return Fe;else{const a=t.get(e.name);let c=s;return a&&(c=c.remove(new y(e.name,a))),c.insert(e,e.node)}});return new te(i,this.indexSet_)}removeFromIndexes(e,t){const i=Qt(this.indexes_,s=>{if(s===Fe)return s;{const r=t.get(e.name);return r?s.remove(new y(e.name,r)):s}});return new te(i,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zd extends bn{constructor(e){super(),this.indexPath_=e,f(!E(e)&&v(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const i=this.extractChild(e.node),s=this.extractChild(t.node),r=i.compareTo(s);return r===0?it(e.name,t.name):r}makePost(e,t){const i=D(e),s=g.EMPTY_NODE.updateChild(this.indexPath_,i);return new y(t,s)}maxPost(){const e=g.EMPTY_NODE.updateChild(this.indexPath_,Ft);return new y(Pe,e)}toString(){return ea(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ef extends bn{compare(e,t){const i=e.node.compareTo(t.node);return i===0?it(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const i=D(e);return new y(t,i)}toString(){return".value"}}const tf=new ef;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hi{constructor(e){this.index_=e}updateChild(e,t,i,s,r,o){f(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(t)?o.trackChildChange(Ct(t,a)):f(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Je(t,i)):o.trackChildChange(St(t,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(t,i).withIndex(this.index_)}updateFullNode(e,t,i){return i!=null&&(e.isLeafNode()||e.forEachChild(R,(s,r)=>{t.hasChild(s)||i.trackChildChange(Ct(s,r))}),t.isLeafNode()||t.forEachChild(R,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(St(s,r,o))}else i.trackChildChange(Je(s,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?g.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=G.ACK_USER_WRITE,this.source=ha()}operationForChild(e){if(E(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new C(e));return new un(T(),t,this.revert)}}else return f(v(this.path)===e,"operationForChild called for unrelated child."),new un(S(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(e,t){this.source=e,this.path=t,this.type=G.LISTEN_COMPLETE}operationForChild(e){return E(this.path)?new Rt(this.source,T()):new Rt(this.source,S(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=G.OVERWRITE}operationForChild(e){return E(this.path)?new Oe(this.source,T(),this.snap.getImmediateChild(e)):new Oe(this.source,S(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=G.MERGE}operationForChild(e){if(E(this.path)){const t=this.children.subtree(new C(e));return t.isEmpty()?null:t.value?new Oe(this.source,T(),t.value):new Nt(this.source,T(),t)}else return f(v(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Nt(this.source,S(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class q{constructor(e){this.writeTree_=e}static empty(){return new q(new b(null))}}function gt(n,e,t){if(E(e))return new q(new b(t));{const i=n.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=F(s,e);return r=r.updateChild(o,t),new q(n.writeTree_.set(s,r))}else{const s=new b(t),r=n.writeTree_.setTree(e,s);return new q(r)}}}function gr(n,e,t){let i=n;return B(t,(s,r)=>{i=gt(i,A(e,s),r)}),i}function vr(n,e){if(E(e))return q.empty();{const t=n.writeTree_.setTree(e,new b(null));return new q(t)}}function hi(n,e){return xe(n,e)!=null}function xe(n,e){const t=n.writeTree_.findRootMostValueAndPath(e);return t!=null?n.writeTree_.get(t.path).getChild(F(t.path,e)):null}function yr(n){const e=[],t=n.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(R,(i,s)=>{e.push(new y(i,s))}):n.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new y(i,s.value))}),e}function ge(n,e){if(E(e))return n;{const t=xe(n,e);return t!=null?new q(new b(t)):new q(n.writeTree_.subtree(e))}}function ui(n){return n.writeTree_.isEmpty()}function Qe(n,e){return da(T(),n.writeTree_,e)}function da(n,e,t){if(e.value!=null)return t.updateChild(n,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(f(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):t=da(A(n,s),r,t)}),!t.getChild(n).isEmpty()&&i!==null&&(t=t.updateChild(A(n,".priority"),i)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ki(n,e){return ma(e,n)}function gf(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=gt(n.visibleWrites,e,t)),n.lastWriteId=i}function vf(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function yf(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&Ef(a,i.path)?s=!1:H(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return If(n),!0;if(i.snap)n.visibleWrites=vr(n.visibleWrites,i.path);else{const a=i.children;B(a,c=>{n.visibleWrites=vr(n.visibleWrites,A(i.path,c))})}return!0}else return!1}function Ef(n,e){if(n.snap)return H(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&H(A(n.path,t),e))return!0;return!1}function If(n){n.visibleWrites=fa(n.allWrites,Tf,T()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function Tf(n){return n.visible}function fa(n,e,t){let i=q.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)H(t,o)?(a=F(t,o),i=gt(i,a,r.snap)):H(o,t)&&(a=F(o,t),i=gt(i,T(),r.snap.getChild(a)));else if(r.children){if(H(t,o))a=F(t,o),i=gr(i,a,r.children);else if(H(o,t))if(a=F(o,t),E(a))i=gr(i,T(),r.children);else{const c=Ke(r.children,v(a));if(c){const l=c.getChild(S(a));i=gt(i,T(),l)}}}else throw Xe("WriteRecord should have .snap or .children")}}return i}function pa(n,e,t,i,s){if(!i&&!s){const r=xe(n.visibleWrites,e);if(r!=null)return r;{const o=ge(n.visibleWrites,e);if(ui(o))return t;if(t==null&&!hi(o,T()))return null;{const a=t||g.EMPTY_NODE;return Qe(o,a)}}}else{const r=ge(n.visibleWrites,e);if(!s&&ui(r))return t;if(!s&&t==null&&!hi(r,T()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(H(l.path,e)||H(e,l.path))},a=fa(n.allWrites,o,e),c=t||g.EMPTY_NODE;return Qe(a,c)}}}function wf(n,e,t){let i=g.EMPTY_NODE;const s=xe(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(R,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=ge(n.visibleWrites,e);return t.forEachChild(R,(o,a)=>{const c=Qe(ge(r,new C(o)),a);i=i.updateImmediateChild(o,c)}),yr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ge(n.visibleWrites,e);return yr(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function Cf(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=A(e,t);if(hi(n.visibleWrites,r))return null;{const o=ge(n.visibleWrites,r);return ui(o)?s.getChild(t):Qe(o,s.getChild(t))}}function Sf(n,e,t,i){const s=A(e,t),r=xe(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=ge(n.visibleWrites,s);return Qe(o,i.getNode().getImmediateChild(t))}else return null}function bf(n,e){return xe(n.visibleWrites,e)}function Rf(n,e,t,i,s,r,o){let a;const c=ge(n.visibleWrites,e),l=xe(c,T());if(l!=null)a=l;else if(t!=null)a=Qe(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=d.getNext();for(;p&&u.length<s;)h(p,i)!==0&&u.push(p),p=d.getNext();return u}else return[]}function Nf(){return{visibleWrites:q.empty(),allWrites:[],lastWriteId:-1}}function dn(n,e,t,i){return pa(n.writeTree,n.treePath,e,t,i)}function ji(n,e){return wf(n.writeTree,n.treePath,e)}function Er(n,e,t,i){return Cf(n.writeTree,n.treePath,e,t,i)}function fn(n,e){return bf(n.writeTree,A(n.treePath,e))}function Af(n,e,t,i,s,r){return Rf(n.writeTree,n.treePath,e,t,i,s,r)}function zi(n,e,t){return Sf(n.writeTree,n.treePath,e,t)}function _a(n,e){return ma(A(n.treePath,e),n.writeTree)}function ma(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pf{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const ga=new Pf;class Yi{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new De(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return zi(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Le(this.viewCache_),r=Af(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Of(n){return{filter:n}}function Df(n,e){f(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),f(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function Lf(n,e,t,i,s){const r=new kf;let o,a;if(t.type===G.OVERWRITE){const l=t;l.source.fromUser?o=di(n,e,l.path,l.snap,i,s,r):(f(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!E(l.path),o=pn(n,e,l.path,l.snap,i,s,a,r))}else if(t.type===G.MERGE){const l=t;l.source.fromUser?o=xf(n,e,l.path,l.children,i,s,r):(f(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=fi(n,e,l.path,l.children,i,s,a,r))}else if(t.type===G.ACK_USER_WRITE){const l=t;l.revert?o=Wf(n,e,l.path,i,s,r):o=Ff(n,e,l.path,l.affectedTree,i,s,r)}else if(t.type===G.LISTEN_COMPLETE)o=Uf(n,e,t.path,i,r);else throw Xe("Unknown operation type: "+t.type);const c=r.getChanges();return Mf(e,o,c),{viewCache:o,changes:c}}function Mf(n,e,t){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=li(n);(t.length>0||!n.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&t.push(ca(li(e)))}}function va(n,e,t,i,s,r){const o=e.eventCache;if(fn(i,t)!=null)return e;{let a,c;if(E(t))if(f(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const l=Le(e),u=l instanceof g?l:g.EMPTY_NODE,h=ji(i,u);a=n.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const l=dn(i,Le(e));a=n.filter.updateFullNode(e.eventCache.getNode(),l,r)}else{const l=v(t);if(l===".priority"){f(ve(t)===1,"Can't have a priority with additional path components");const u=o.getNode();c=e.serverCache.getNode();const h=Er(i,t,u,c);h!=null?a=n.filter.updatePriority(u,h):a=o.getNode()}else{const u=S(t);let h;if(o.isCompleteForChild(l)){c=e.serverCache.getNode();const d=Er(i,t,o.getNode(),c);d!=null?h=o.getNode().getImmediateChild(l).updateChild(u,d):h=o.getNode().getImmediateChild(l)}else h=zi(i,l,e.serverCache);h!=null?a=n.filter.updateChild(o.getNode(),l,h,u,s,r):a=o.getNode()}}return mt(e,a,o.isFullyInitialized()||E(t),n.filter.filtersNodes())}}function pn(n,e,t,i,s,r,o,a){const c=e.serverCache;let l;const u=o?n.filter:n.filter.getIndexedFilter();if(E(t))l=u.updateFullNode(c.getNode(),i,null);else if(u.filtersNodes()&&!c.isFiltered()){const p=c.getNode().updateChild(t,i);l=u.updateFullNode(c.getNode(),p,null)}else{const p=v(t);if(!c.isCompleteForPath(t)&&ve(t)>1)return e;const _=S(t),N=c.getNode().getImmediateChild(p).updateChild(_,i);p===".priority"?l=u.updatePriority(c.getNode(),N):l=u.updateChild(c.getNode(),p,N,_,ga,null)}const h=ua(e,l,c.isFullyInitialized()||E(t),u.filtersNodes()),d=new Yi(s,h,r);return va(n,h,t,s,d,a)}function di(n,e,t,i,s,r,o){const a=e.eventCache;let c,l;const u=new Yi(s,e,r);if(E(t))l=n.filter.updateFullNode(e.eventCache.getNode(),i,o),c=mt(e,l,!0,n.filter.filtersNodes());else{const h=v(t);if(h===".priority")l=n.filter.updatePriority(e.eventCache.getNode(),i),c=mt(e,l,a.isFullyInitialized(),a.isFiltered());else{const d=S(t),p=a.getNode().getImmediateChild(h);let _;if(E(d))_=i;else{const I=u.getCompleteChild(h);I!=null?Zo(d)===".priority"&&I.getChild(ta(d)).isEmpty()?_=I:_=I.updateChild(d,i):_=g.EMPTY_NODE}if(p.equals(_))c=e;else{const I=n.filter.updateChild(a.getNode(),h,_,d,u,o);c=mt(e,I,a.isFullyInitialized(),n.filter.filtersNodes())}}}return c}function Ir(n,e){return n.eventCache.isCompleteForChild(e)}function xf(n,e,t,i,s,r,o){let a=e;return i.foreach((c,l)=>{const u=A(t,c);Ir(e,v(u))&&(a=di(n,a,u,l,s,r,o))}),i.foreach((c,l)=>{const u=A(t,c);Ir(e,v(u))||(a=di(n,a,u,l,s,r,o))}),a}function Tr(n,e,t){return t.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function fi(n,e,t,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let c=e,l;E(t)?l=i:l=new b(null).setTree(t,i);const u=e.serverCache.getNode();return l.children.inorderTraversal((h,d)=>{if(u.hasChild(h)){const p=e.serverCache.getNode().getImmediateChild(h),_=Tr(n,p,d);c=pn(n,c,new C(h),_,s,r,o,a)}}),l.children.inorderTraversal((h,d)=>{const p=!e.serverCache.isCompleteForChild(h)&&d.value===null;if(!u.hasChild(h)&&!p){const _=e.serverCache.getNode().getImmediateChild(h),I=Tr(n,_,d);c=pn(n,c,new C(h),I,s,r,o,a)}}),c}function Ff(n,e,t,i,s,r,o){if(fn(s,t)!=null)return e;const a=e.serverCache.isFiltered(),c=e.serverCache;if(i.value!=null){if(E(t)&&c.isFullyInitialized()||c.isCompleteForPath(t))return pn(n,e,t,c.getNode().getChild(t),s,r,a,o);if(E(t)){let l=new b(null);return c.getNode().forEachChild(qe,(u,h)=>{l=l.set(new C(u),h)}),fi(n,e,t,l,s,r,a,o)}else return e}else{let l=new b(null);return i.foreach((u,h)=>{const d=A(t,u);c.isCompleteForPath(d)&&(l=l.set(u,c.getNode().getChild(d)))}),fi(n,e,t,l,s,r,a,o)}}function Uf(n,e,t,i,s){const r=e.serverCache,o=ua(e,r.getNode(),r.isFullyInitialized()||E(t),r.isFiltered());return va(n,o,t,i,ga,s)}function Wf(n,e,t,i,s,r){let o;if(fn(i,t)!=null)return e;{const a=new Yi(i,e,s),c=e.eventCache.getNode();let l;if(E(t)||v(t)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=dn(i,Le(e));else{const h=e.serverCache.getNode();f(h instanceof g,"serverChildren would be complete if leaf node"),u=ji(i,h)}u=u,l=n.filter.updateFullNode(c,u,r)}else{const u=v(t);let h=zi(i,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=c.getImmediateChild(u)),h!=null?l=n.filter.updateChild(c,u,h,S(t),a,r):e.eventCache.getNode().hasChild(u)?l=n.filter.updateChild(c,u,g.EMPTY_NODE,S(t),a,r):l=c,l.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=dn(i,Le(e)),o.isLeafNode()&&(l=n.filter.updateFullNode(l,o,r)))}return o=e.serverCache.isFullyInitialized()||fn(i,T())!=null,mt(e,l,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let _n;class $f{constructor(){this.views=new Map}}function Kf(n){f(!_n,"__referenceConstructor has already been defined"),_n=n}function jf(){return f(_n,"Reference.ts has not been loaded"),_n}function zf(n){return n.views.size===0}function Ji(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return f(r!=null,"SyncTree gave us an op for an invalid query."),Sr(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(Sr(o,e,t,i));return r}}function Yf(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=dn(t,s?i:null),c=!1;a?c=!0:i instanceof g?(a=ji(t,i),c=!1):(a=g.EMPTY_NODE,c=!1);const l=Rn(new De(a,c,!1),new De(i,s,!1));return new Bf(e,l)}return o}function Jf(n,e,t,i,s,r){const o=Yf(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Gf(o,t),qf(o,t)}function Qf(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=ye(n);if(s==="default")for(const[c,l]of n.views.entries())o=o.concat(Cr(l,t,i)),wr(l)&&(n.views.delete(c),l.query._queryParams.loadsAllData()||r.push(l.query));else{const c=n.views.get(s);c&&(o=o.concat(Cr(c,t,i)),wr(c)&&(n.views.delete(s),c.query._queryParams.loadsAllData()||r.push(c.query)))}return a&&!ye(n)&&r.push(new(jf())(e._repo,e._path)),{removed:r,events:o}}function Ea(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function $e(n,e){let t=null;for(const i of n.views.values())t=t||Hf(i,e);return t}function Ia(n,e){if(e._queryParams.loadsAllData())return Nn(n);{const i=e._queryIdentifier;return n.views.get(i)}}function Ta(n,e){return Ia(n,e)!=null}function ye(n){return Nn(n)!=null}function Nn(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let mn;function Xf(n){f(!mn,"__referenceConstructor has already been defined"),mn=n}function Zf(){return f(mn,"Reference.ts has not been loaded"),mn}let ep=1;class br{constructor(e){this.listenProvider_=e,this.syncPointTree_=new b(null),this.pendingWriteTree_=Nf(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function wa(n,e,t,i,s){return gf(n.pendingWriteTree_,e,t,i,s),s?Ut(n,new Oe(ha(),e,t)):[]}function Ne(n,e,t=!1){const i=vf(n.pendingWriteTree_,e);if(yf(n.pendingWriteTree_,e)){let r=new b(null);return i.snap!=null?r=r.set(T(),!0):B(i.children,o=>{r=r.set(new C(o),!0)}),Ut(n,new un(i.path,r,t))}else return[]}function An(n,e,t){return Ut(n,new Oe(qi(),e,t))}function tp(n,e,t){const i=b.fromObject(t);return Ut(n,new Nt(qi(),e,i))}function np(n,e){return Ut(n,new Rt(qi(),e))}function ip(n,e,t){const i=Xi(n,t);if(i){const s=Zi(i),r=s.path,o=s.queryId,a=F(r,e),c=new Rt($i(o),a);return es(n,r,c)}else return[]}function pi(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Ta(o,e))){const c=Qf(o,e,t,i);zf(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const l=c.removed;if(a=c.events,!s){const u=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,h=n.syncPointTree_.findOnPath(r,(d,p)=>ye(p));if(u&&!h){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const p=op(d);for(let _=0;_<p.length;++_){const I=p[_],N=I.query,Y=ba(n,I);n.listenProvider_.startListening(vt(N),gn(n,N),Y.hashFn,Y.onComplete)}}}!h&&l.length>0&&!i&&(u?n.listenProvider_.stopListening(vt(e),null):l.forEach(d=>{const p=n.queryToTagMap.get(kn(d));n.listenProvider_.stopListening(vt(d),p)}))}ap(n,l)}return a}function sp(n,e,t,i){const s=Xi(n,i);if(s!=null){const r=Zi(s),o=r.path,a=r.queryId,c=F(o,e),l=new Oe($i(a),c,t);return es(n,o,l)}else return[]}function rp(n,e,t,i){const s=Xi(n,i);if(s){const r=Zi(s),o=r.path,a=r.queryId,c=F(o,e),l=b.fromObject(t),u=new Nt($i(a),c,l);return es(n,o,u)}else return[]}function Rr(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(d,p)=>{const _=F(d,s);r=r||$e(p,_),o=o||ye(p)});let a=n.syncPointTree_.get(s);a?(o=o||ye(a),r=r||$e(a,T())):(a=new $f,n.syncPointTree_=n.syncPointTree_.set(s,a));let c;r!=null?c=!0:(c=!1,r=g.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((p,_)=>{const I=$e(_,T());I&&(r=r.updateImmediateChild(p,I))}));const l=Ta(a,e);if(!l&&!e._queryParams.loadsAllData()){const d=kn(e);f(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const p=cp();n.queryToTagMap.set(d,p),n.tagToQueryMap.set(p,d)}const u=Ki(n.pendingWriteTree_,s);let h=Jf(a,e,t,u,r,c);if(!l&&!o&&!i){const d=Ia(a,e);h=h.concat(lp(n,e,d))}return h}function Qi(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=F(o,e),l=$e(a,c);if(l)return l});return pa(s,e,r,t,!0)}function Ut(n,e){return Ca(e,n.syncPointTree_,null,Ki(n.pendingWriteTree_,T()))}function Ca(n,e,t,i){if(E(n.path))return Sa(n,e,t,i);{const s=e.get(T());t==null&&s!=null&&(t=$e(s,T()));let r=[];const o=v(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,u=_a(i,o);r=r.concat(Ca(a,c,l,u))}return s&&(r=r.concat(Ji(s,n,i,t))),r}}function Sa(n,e,t,i){const s=e.get(T());t==null&&s!=null&&(t=$e(s,T()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=_a(i,o),u=n.operationForChild(o);u&&(r=r.concat(Sa(u,a,c,l)))}),s&&(r=r.concat(Ji(s,n,i,t))),r}function ba(n,e){const t=e.query,i=gn(n,t);return{hashFn:()=>(Vf(e)||g.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?ip(n,t._path,i):np(n,t._path);{const r=id(s,t);return pi(n,t,null,r)}}}}function gn(n,e){const t=kn(e);return n.queryToTagMap.get(t)}function kn(n){return n._path.toString()+"$"+n._queryIdentifier}function Xi(n,e){return n.tagToQueryMap.get(e)}function Zi(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new C(n.substr(0,e))}}function es(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=Ki(n.pendingWriteTree_,e);return Ji(i,t,s,null)}function op(n){return n.fold((e,t,i)=>{if(t&&ye(t))return[Nn(t)];{let s=[];return t&&(s=Ea(t)),B(i,(r,o)=>{s=s.concat(o)}),s}})}function vt(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Zf())(n._repo,n._path):n}function ap(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=kn(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function cp(){return ep++}function lp(n,e,t){const i=e._path,s=gn(n,e),r=ba(n,t),o=n.listenProvider_.startListening(vt(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)f(!ye(a.value),"If we're adding a query, it shouldn't be shadowed");else{const c=a.fold((l,u,h)=>{if(!E(l)&&u&&ye(u))return[Nn(u).query];{let d=[];return u&&(d=d.concat(Ea(u).map(p=>p.query))),B(h,(p,_)=>{d=d.concat(_)}),d}});for(let l=0;l<c.length;++l){const u=c[l];n.listenProvider_.stopListening(vt(u),gn(n,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ts(t)}node(){return this.node_}}class ns{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=A(this.path_,e);return new ns(this.syncTree_,t)}node(){return Qi(this.syncTree_,this.path_)}}const hp=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},Nr=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return up(n[".sv"],e,t);if(typeof n[".sv"]=="object")return dp(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},up=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},dp=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const i=n.increment;typeof i!="number"&&f(!1,"Unexpected increment value: "+i);const s=e.node();if(f(s!==null&&typeof s<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const o=s.getValue();return typeof o!="number"?i:o+i},fp=function(n,e,t,i){return is(e,new ns(t,n),i)},Ra=function(n,e,t){return is(n,new ts(e),t)};function is(n,e,t){const i=n.getPriority().val(),s=Nr(i,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=Nr(o.getValue(),e,t);return a!==o.getValue()||s!==o.getPriority().val()?new k(a,D(s)):n}else{const o=n;return r=o,s!==o.getPriority().val()&&(r=r.updatePriority(new k(s))),o.forEachChild(R,(a,c)=>{const l=is(c,e.getImmediateChild(a),t);l!==c&&(r=r.updateImmediateChild(a,l))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gp=/[\[\].#$\/\u0000-\u001F\u007F]/,vp=/[\[\].#$\u0000-\u001F\u007F]/,zn=10*1024*1024,Pa=function(n){return typeof n=="string"&&n.length!==0&&!gp.test(n)},Oa=function(n){return typeof n=="string"&&n.length!==0&&!vp.test(n)},yp=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Oa(n)},Da=function(n,e,t,i){i&&e===void 0||os(Ti(n,"value"),e,t)},os=function(n,e,t){const i=t instanceof C?new xd(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+be(i));if(typeof e=="function")throw new Error(n+"contains a function "+be(i)+" with contents = "+e.toString());if(Oo(e))throw new Error(n+"contains "+e.toString()+" "+be(i));if(typeof e=="string"&&e.length>zn/3&&In(e)>zn)throw new Error(n+"contains a string greater than "+zn+" utf8 bytes "+be(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(B(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Pa(o)))throw new Error(n+" contains an invalid key ("+o+") "+be(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Fd(i,o),os(n,a,i),Ud(i)}),s&&r)throw new Error(n+' contains ".value" child '+be(i)+" in addition to actual children.")}},La=function(n,e,t,i){if(!Oa(t))throw new Error(Ti(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Ep=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),La(n,e,t)},Ma=function(n,e){if(v(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Ip=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Pa(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!yp(t))throw new Error(Ti(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tp{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function as(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Wi(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function xa(n,e,t){as(n,t),Fa(n,i=>Wi(i,e))}function oe(n,e,t){as(n,t),Fa(n,i=>H(i,e)||H(e,i))}function Fa(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(wp(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function wp(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();pt&&L("event: "+t.toString()),st(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cp="repo_interrupt",Sp=25;class bp{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new Tp,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=hn(),this.transactionQueueTree_=new ss,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Rp(n,e,t){if(n.stats_=Fi(n.repoInfo_),n.forceRestClient_||ad())n.server_=new ln(n.repoInfo_,(i,s,r,o)=>{Ar(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>kr(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{O(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new ne(n.repoInfo_,e,(i,s,r,o)=>{Ar(n,i,s,r,o)},i=>{kr(n,i)},i=>{Np(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=dd(n.repoInfo_,()=>new uf(n.stats_,n.server_)),n.infoData_=new of,n.infoSyncTree_=new br({startListening:(i,s,r,o)=>{let a=[];const c=n.infoData_.getNode(i._path);return c.isEmpty()||(a=An(n.infoSyncTree_,i._path,c),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),ls(n,"connected",!1),n.serverSyncTree_=new br({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,c)=>{const l=o(a,c);oe(n.eventQueue_,i._path,l)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function Ua(n){const t=n.infoData_.getNode(new C(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function cs(n){return hp({timestamp:Ua(n)})}function Ar(n,e,t,i,s){n.dataUpdateCount++;const r=new C(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const c=Qt(t,l=>D(l));o=rp(n.serverSyncTree_,r,c,s)}else{const c=D(t);o=sp(n.serverSyncTree_,r,c,s)}else if(i){const c=Qt(t,l=>D(l));o=tp(n.serverSyncTree_,r,c)}else{const c=D(t);o=An(n.serverSyncTree_,r,c)}let a=r;o.length>0&&(a=On(n,r)),oe(n.eventQueue_,a,o)}function kr(n,e){ls(n,"connected",e),e===!1&&kp(n)}function Np(n,e){B(e,(t,i)=>{ls(n,t,i)})}function ls(n,e,t){const i=new C("/.info/"+e),s=D(t);n.infoData_.updateSnapshot(i,s);const r=An(n.infoSyncTree_,i,s);oe(n.eventQueue_,i,r)}function Wa(n){return n.nextWriteId_++}function Ap(n,e,t,i,s){hs(n,"set",{path:e.toString(),value:t,priority:i});const r=cs(n),o=D(t,i),a=Qi(n.serverSyncTree_,e),c=Ra(o,a,r),l=Wa(n),u=wa(n.serverSyncTree_,e,c,l,!0);as(n.eventQueue_,u),n.server_.put(e.toString(),o.val(!0),(d,p)=>{const _=d==="ok";_||W("set at "+e+" failed: "+d);const I=Ne(n.serverSyncTree_,l,!_);oe(n.eventQueue_,e,I),Lp(n,s,d,p)});const h=qa(n,e);On(n,h),oe(n.eventQueue_,h,[])}function kp(n){hs(n,"onDisconnectEvents");const e=cs(n),t=hn();ci(n.onDisconnect_,T(),(s,r)=>{const o=fp(s,r,n.serverSyncTree_,e);la(t,s,o)});let i=[];ci(t,T(),(s,r)=>{i=i.concat(An(n.serverSyncTree_,s,r));const o=qa(n,s);On(n,o)}),n.onDisconnect_=hn(),oe(n.eventQueue_,T(),i)}function Pp(n,e,t){let i;v(e._path)===".info"?i=Rr(n.infoSyncTree_,e,t):i=Rr(n.serverSyncTree_,e,t),xa(n.eventQueue_,e._path,i)}function Op(n,e,t){let i;v(e._path)===".info"?i=pi(n.infoSyncTree_,e,t):i=pi(n.serverSyncTree_,e,t),xa(n.eventQueue_,e._path,i)}function Dp(n){n.persistentConnection_&&n.persistentConnection_.interrupt(Cp)}function hs(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),L(t,...e)}function Lp(n,e,t,i){e&&st(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function Ba(n,e,t){return Qi(n.serverSyncTree_,e,t)||g.EMPTY_NODE}function us(n,e=n.transactionQueueTree_){if(e||Dn(n,e),rt(e)){const t=Ha(n,e);f(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&Mp(n,Wt(e),t)}else Aa(e)&&Pn(e,t=>{us(n,t)})}function Mp(n,e,t){const i=t.map(l=>l.currentWriteId),s=Ba(n,e,i);let r=s;const o=s.hash();for(let l=0;l<t.length;l++){const u=t[l];f(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=F(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),c=e;n.server_.put(c.toString(),a,l=>{hs(n,"transaction put response",{path:c.toString(),status:l});let u=[];if(l==="ok"){const h=[];for(let d=0;d<t.length;d++)t[d].status=2,u=u.concat(Ne(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&h.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();Dn(n,rs(n.transactionQueueTree_,e)),us(n,n.transactionQueueTree_),oe(n.eventQueue_,e,u);for(let d=0;d<h.length;d++)st(h[d])}else{if(l==="datastale")for(let h=0;h<t.length;h++)t[h].status===3?t[h].status=4:t[h].status=0;else{W("transaction at "+c.toString()+" failed: "+l);for(let h=0;h<t.length;h++)t[h].status=4,t[h].abortReason=l}On(n,e)}},o)}function On(n,e){const t=Va(n,e),i=Wt(t),s=Ha(n,t);return xp(n,s,i),i}function xp(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const c=e[a],l=F(t,c.path);let u=!1,h;if(f(l!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),c.status===4)u=!0,h=c.abortReason,s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0));else if(c.status===0)if(c.retryCount>=Sp)u=!0,h="maxretry",s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0));else{const d=Ba(n,c.path,o);c.currentInputSnapshot=d;const p=e[a].update(d.val());if(p!==void 0){os("transaction failed: Data returned ",p,c.path);let _=D(p);typeof p=="object"&&p!=null&&ae(p,".priority")||(_=_.updatePriority(d.getPriority()));const N=c.currentWriteId,Y=cs(n),we=Ra(_,d,Y);c.currentOutputSnapshotRaw=_,c.currentOutputSnapshotResolved=we,c.currentWriteId=Wa(n),o.splice(o.indexOf(N),1),s=s.concat(wa(n.serverSyncTree_,c.path,we,c.currentWriteId,c.applyLocally)),s=s.concat(Ne(n.serverSyncTree_,N,!0))}else u=!0,h="nodata",s=s.concat(Ne(n.serverSyncTree_,c.currentWriteId,!0))}oe(n.eventQueue_,t,s),s=[],u&&(e[a].status=2,(function(d){setTimeout(d,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(h),!1,null))))}Dn(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)st(i[a]);us(n,n.transactionQueueTree_)}function Va(n,e){let t,i=n.transactionQueueTree_;for(t=v(e);t!==null&&rt(i)===void 0;)i=rs(i,t),e=S(e),t=v(e);return i}function Ha(n,e){const t=[];return Ga(n,e,t),t.sort((i,s)=>i.order-s.order),t}function Ga(n,e,t){const i=rt(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);Pn(e,s=>{Ga(n,s,t)})}function Dn(n,e){const t=rt(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,Na(e,t.length>0?t:void 0)}Pn(e,i=>{Dn(n,i)})}function qa(n,e){const t=Wt(Va(n,e)),i=rs(n.transactionQueueTree_,e);return _p(i,s=>{Yn(n,s)}),Yn(n,i),ka(i,s=>{Yn(n,s)}),t}function Yn(n,e){const t=rt(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(f(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(f(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(Ne(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Na(e,void 0):t.length=r+1,oe(n.eventQueue_,Wt(e),s);for(let o=0;o<i.length;o++)st(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ds{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return E(this._path)?null:Zo(this._path)}get ref(){return new Te(this._repo,this._path)}get _queryIdentifier(){const e=_r(this._queryParams),t=Mi(e);return t==="{}"?"default":t}get _queryObject(){return _r(this._queryParams)}isEqual(e){if(e=x(e),!(e instanceof ds))return!1;const t=this._repo===e._repo,i=Wi(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Md(this._path)}}class Te extends ds{constructor(e,t){super(e,t,new Gi,!1)}get parent(){const e=ta(this._path);return e===null?null:new Te(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class vn{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new C(e),i=At(this.ref,e);return new vn(this._node.getChild(t),i,R)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new vn(s,At(this.ref,i),R)))}hasChild(e){const t=new C(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function fs(n,e){return n=x(n),n._checkNotDeleted("ref"),e!==void 0?At(n._root,e):n._root}function At(n,e){return n=x(n),v(n._path)===null?Ep("child","path",e):La("child","path",e),new Te(n._repo,A(n._path,e))}function qp(n,e){n=x(n),Ma("push",n._path),Da("push",e,n._path,!0);const t=Ua(n._repo),i=Bp(t),s=At(n,i),r=At(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function $a(n,e){n=x(n),Ma("set",n._path),Da("set",e,n._path,!1);const t=new En;return Ap(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class ps{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new Vp("value",this,new vn(e.snapshotNode,new Te(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Hp(this,e,t):null}matches(e){return e instanceof ps?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function $p(n,e,t,i,s){const r=new Gp(t,void 0),o=new ps(r);return Pp(n._repo,n,o),()=>Op(n._repo,n,o)}function Kp(n,e,t,i){return $p(n,"value",e)}Kf(Te);Xf(Te);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function n_(n){Ku(et),je(new Ae("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Jp(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),_e(Xs,Zs,n),_e(Xs,Zs,"esm2017")}ne.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ne.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};n_();const i_={apiKey:"AIzaSyBXqi_wmAdr5AbiS9k8Rul1ERbg5Tn73MI",authDomain:"tegelv2.firebaseapp.com",databaseURL:"https://tegelv2.firebaseio.com",projectId:"tegelv2",storageBucket:"tegelv2.firebasestorage.app",messagingSenderId:"1053223905500",appId:"1:1053223905500:web:fc9f7d25213aea0d18ec19"},Ka=$r(i_),kt=qu(Ka),_s=e_(Ka);function s_(n){const e=fs(_s,"events");return Kp(e,t=>{const i=t.val();if(!i){n([]);return}const s=Object.keys(i).map(r=>({...i[r],id:r}));n(s)})}async function r_(n){const e=fs(_s,"events"),t=qp(e);return $a(t,n)}async function o_(n){const e=fs(_s,`events/${n}`);return $a(e,null)}function a_(n,e,t){const i=[],s=new Date(n,e+1,0);for(let r=1;r<=s.getDate();r++){const o=new Date(n,e,r),a=o.getTime(),c=new Date(n,e,r,23,59,59,999).getTime(),l=t.filter(_=>_.start<c&&_.end>a),u=o.getFullYear(),h=String(o.getMonth()+1).padStart(2,"0"),d=String(o.getDate()).padStart(2,"0"),p=`${u}-${h}-${d}`;i.push({date:p,dayOfMonth:r,events:l})}return{days:i}}function c_(n,e){return e.some(t=>n.start<t.end&&n.end>t.start)}Xa({immediate:!0});const yn=document.querySelector("#app"),ms=document.createElement("div");ms.className="toast-container";document.body.appendChild(ms);let ht=new Date().getFullYear(),J=new Date().getMonth(),gi=[];const Dr=[{text:"HYR EN IGELKOTT SOM SÄLLSKAP - 20 KR/DAG",image:"https://images.unsplash.com/photo-1584447128309-b66b7a4d1b63?auto=format&fit=crop&q=80&w=800"},{text:"BLI CERTIFIERAD MOLNSKÅDARE - ANMÄL DIG NU",image:"https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&q=80&w=800"},{text:"GÖR DIN EGEN OST I BADKARET: STARTKIT",image:"https://images.unsplash.com/photo-1486297678162-ad2a19b05840?auto=format&fit=crop&q=80&w=800"},{text:"KURSER I ATT STIRRA PÅ GETTER",image:"https://images.unsplash.com/photo-1524024973431-2ad916746881?auto=format&fit=crop&q=80&w=800"},{text:"ABONNEMANG PÅ SLUMPMÄSSIGA STENAR",image:"https://images.unsplash.com/photo-1525857597365-5f6dbff2e36e?auto=format&fit=crop&q=80&w=800"},{text:"VATTENTÄTA TEPÅSAR - BRYGG UNDER VATTEN!",image:"https://images.unsplash.com/photo-1544787210-2211d7c309c7?auto=format&fit=crop&q=80&w=800"},{text:"LÄR DIN GULDFISK ATT SJUNGA OPERA",image:"https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?auto=format&fit=crop&q=80&w=800"},{text:"SÄLJ DIN SKUGGA TILL HÖGSTBJUDANDE",image:"https://images.unsplash.com/photo-1508020482468-fd295744b9ca?auto=format&fit=crop&q=80&w=800"},{text:"EXTRA LÅNG SPAGHETTI FÖR ENSAMMA KVÄLLAR",image:"https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&q=80&w=800"},{text:"HAR DU SETT EN UFO? RAPPORTERA HÄR!",image:"https://images.unsplash.com/photo-1506466010722-395ee2bef877?auto=format&fit=crop&q=80&w=800"},{text:"PLÖJ SOM ETT PROFFS MED TRAKTOR-KRAFT",image:"https://images.unsplash.com/photo-1589923188900-85dae523342b?auto=format&fit=crop&q=80&w=800"},{text:"SPÅDOM I FISKINNÄLVOR - BOKA TID",image:"https://images.unsplash.com/photo-1469122312224-c5846569efe1?auto=format&fit=crop&q=80&w=800"},{text:"TALA MED DINA VÄXTER - NY KURS STARTAR NU",image:"https://images.unsplash.com/photo-1453904300235-0f2f60b15b5d?auto=format&fit=crop&q=80&w=800"},{text:"ÄR DIN KATT EN RYMDVARELSE? TESTA HÄR",image:"https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&q=80&w=800"},{text:"JÄTTE-TRAKTOR TILL SALU: FÖRST TILL KVARN",image:"https://images.unsplash.com/photo-1594411130638-349f7e346f9f?auto=format&fit=crop&q=80&w=800"},{text:"HYR EN PERSON SOM NICKAR IMPONERAT ÅT ALLT DU SÄGER",image:"https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=800"},{text:"VI LÄSER DIN FRAMTID I EN ÖVERKOKT SPAGHETTI",image:"https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN HALV OSYNLIG STOL – SITT OM DU VÅGAR",image:"https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&q=80&w=800"},{text:"DIN GRANNE ÄR TROLIGEN EN ÖDLA – TESTA HÄR",image:"https://images.unsplash.com/photo-1526336024174-e58f5cdd8e13?auto=format&fit=crop&q=80&w=800"},{text:"KURS: SKRIK PÅ MOLN FÖR PERSONLIG UTVECKLING",image:"https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&q=80&w=800"},{text:"VI TRÄNAR DIN KAKTUS ATT SKYDDA DITT HEM",image:"https://images.unsplash.com/photo-1509423350716-97f2360af2e4?auto=format&fit=crop&q=80&w=800"},{text:"FÅ DIN SKUGGA ATT ARBETA ÖVERTID",image:"https://images.unsplash.com/photo-1508020482468-fd295744b9ca?auto=format&fit=crop&q=80&w=800"},{text:"SÄLJ DIN SJÄL FÖR EN KUPONG PÅ FALAFEL",image:"https://images.unsplash.com/photo-1562967916-eb82221dfb92?auto=format&fit=crop&q=80&w=800"},{text:"EXTRA LÅNG BANAN FÖR FILOSOFISKA DISKUSSIONER",image:"https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?auto=format&fit=crop&q=80&w=800"},{text:"HYR EN MÅS SOM SKRIKER DITT NAMN I GRYNINGEN",image:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN DÖRR SOM LEDER TILL EN ANNAN DÖRR",image:"https://images.unsplash.com/photo-1519710164239-da123dc03ef4?auto=format&fit=crop&q=80&w=800"},{text:"STARTKIT FÖR ATT BLI LOKAL LEGENd I EN PARK",image:"https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&q=80&w=800"},{text:"VI ÖVERSÄTTER DIN HUNDS EXISTENTIELLA KRIS",image:"https://images.unsplash.com/photo-1517423440428-a5a00ad493e8?auto=format&fit=crop&q=80&w=800"},{text:"MYSTISK KNAPP – TRYCK INTE PÅ DEN",image:"https://images.unsplash.com/photo-1518779578993-ec3579fee39f?auto=format&fit=crop&q=80&w=800"},{text:"BLI JAGAD AV EN PERSON I KYCKLINGDRÄKT (MOTIVATION)",image:"https://images.unsplash.com/photo-1606857521015-7f9fcf423740?auto=format&fit=crop&q=80&w=800"},{text:"KURS I ATT MISSTOLKA VANLIGA SAKER",image:"https://images.unsplash.com/photo-1492724441997-5dc865305da7?auto=format&fit=crop&q=80&w=800"},{text:"PRENUMERERA PÅ VECKANS KONSTIGA POTATIS",image:"https://images.unsplash.com/photo-1518977676601-b53f82aba655?auto=format&fit=crop&q=80&w=800"},{text:"DIN BRÖDROST VISKAR OM NATTEN – VI FÖRKLARAR VARFÖR",image:"https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&q=80&w=800"},{text:"TEST: ÄR DU EGENTLIGEN TRE IGELKOTTAR I EN ROCK?",image:"https://images.unsplash.com/photo-1584447128309-b66b7a4d1b63?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN STEN SOM KÄNNER DINA HEMLIGHETER",image:"https://images.unsplash.com/photo-1525857597365-5f6dbff2e36e?auto=format&fit=crop&q=80&w=800"},{text:"VI LÄR DIN BRÖDROST ATT SPELA SCHACK",image:"https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&q=80&w=800"},{text:"TEST: ÄR DIN SOFFA EGENTLIGEN EN AGENT?",image:"https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80&w=800"},{text:"FÅ EN DAGLIG FÖROLÄMPNING FRÅN EN PAPPEGOJA",image:"https://images.unsplash.com/photo-1552728089-57bdde30beb3?auto=format&fit=crop&q=80&w=800"},{text:"PRENUMERERA PÅ MYSTISKA LJUD FRÅN DIN GARDEROB",image:"https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN BANAN SOM DÖMER DIG",image:"https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?auto=format&fit=crop&q=80&w=800"},{text:"DIN MIKROVÅGSUGN HAR ÅSIKTER – HÖR DEM HÄR",image:"https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?auto=format&fit=crop&q=80&w=800"},{text:"KURS: ATT GÅ FÖRBI NÅGON UTAN ATT VETA ÅT VILKET HÅLL",image:"https://images.unsplash.com/photo-1492724441997-5dc865305da7?auto=format&fit=crop&q=80&w=800"},{text:"FÅ EN PERSON SOM VISKAR 'WOW' VARJE GÅNG DU JOBBAR",image:"https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=800"},{text:"VI UTVÄRDERAR DIN POTATIS PERSONLIGHET",image:"https://images.unsplash.com/photo-1518977676601-b53f82aba655?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN KNAPP SOM STARTAR DRAMATISK MUSIK",image:"https://images.unsplash.com/photo-1518779578993-ec3579fee39f?auto=format&fit=crop&q=80&w=800"},{text:"DIN KATT PLANERAR NÅGOT – LÄS RAPPORTEN",image:"https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&q=80&w=800"},{text:"HYR EN VIKING SOM NICKAR GODKÄNNANDE",image:"https://images.unsplash.com/photo-1605640840605-14ac1855827b?auto=format&fit=crop&q=80&w=800"},{text:"TEST: ÄR DU TRE MÖSS I EN ROCK?",image:"https://images.unsplash.com/photo-1518791841217-8f162f1e1131?auto=format&fit=crop&q=80&w=800"},{text:"KÖP EN DÖRR SOM IBLAND APPLÅDERAR",image:"https://images.unsplash.com/photo-1519710164239-da123dc03ef4?auto=format&fit=crop&q=80&w=800"},{text:"KURS I ATT TÄVLA MOT DUvor I ATT GÅ",image:"https://images.unsplash.com/photo-1501706362039-c6e80948bb8b?auto=format&fit=crop&q=80&w=800"},{text:"VI SKICKAR EN PERSON SOM SÄGER 'DET VAR JAG SOM SA DET'",image:"https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&q=80&w=800"},{text:"LÅT EN MUNK FÖRKLARA DINA TOASTERSYNDER",image:"https://images.unsplash.com/photo-1481833761820-0509d3217039?auto=format&fit=crop&q=80&w=800"},{text:"DIN SKO HAR HEMLIGHETER – VI PRESSAR DEN",image:"https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=800"},{text:"ABONNERA PÅ EN DAGLIG FÖRVIRRANDE FAKTA OM GURKOR",image:"https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?auto=format&fit=crop&q=80&w=800"}];function gs(){const n=document.querySelectorAll(".ad-space"),e=["style-tabloid","style-neon","style-vintage","style-urgent","style-comic","style-glitch","style-luxury","style-retro90","style-terminal","style-sticker","style-horror","style-minimal"];n.forEach(t=>{const i=()=>{const s=t,r=Dr[Math.floor(Math.random()*Dr.length)],o=e[Math.floor(Math.random()*e.length)],a=["zoom","shake","drift","pulse"],c=a[Math.floor(Math.random()*a.length)];s.dataset.anim=c;const l=new Image;l.src=r.image,l.onload=()=>{e.forEach(u=>s.classList.remove(u)),s.classList.add(o),s.innerHTML=`
    ...
    `,document.body.appendChild(i);const s=()=>{i.classList.remove("active"),setTimeout(()=>i.remove(),300)};(r=document.getElementById("confirm-no"))==null||r.addEventListener("click",s),(o=document.getElementById("confirm-yes"))==null||o.addEventListener("click",()=>{e(),s()})}function u_(n,e){var s,r;const t=document.querySelector(".modal-overlay");t&&t.remove();const i=document.createElement("div");i.className="modal-overlay active",i.innerHTML=`
        <div class="modal-content">
            <h2>Book Event</h2>
    ...
    `,document.body.appendChild(i),(s=document.getElementById("cancel-booking"))==null||s.addEventListener("click",()=>{i.classList.remove("active"),setTimeout(()=>i.remove(),300)}),(r=document.getElementById("confirm-booking"))==null||r.addEventListener("click",async()=>{const o=document.getElementById("event-title").value,a=document.getElementById("event-start").value,c=document.getElementById("event-end").value;if(!o){K("Please enter a title","error");return}const l=new Date(`${n}T${a}`).getTime(),u=new Date(`${n}T${c}`).getTime();if(u<=l){K("End time must be after start time","error");return}if(c_({start:l,end:u},e)){K("This time slot is already booked!","error");return}const h=kt.currentUser;if(h)try{await r_({userId:h.uid,title:o,start:l,end:u,email:h.email||"",color:"#"+Math.floor(Math.random()*16777215).toString(16)}),K("Event booked!"),i.classList.remove("active"),setTimeout(()=>i.remove(),300)}catch(d){K(d.message,"error")}})}function vi(){var r,o,a;yn.classList.remove("auth-mode");const n=["January","February","March","April","May","June","July","August","September","October","November","December"],e=a_(ht,J,gi),t=new Date,i=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`;yn.innerHTML=`
            ...
            ${e.days.map(c=>`
                <div class="day-cell ${c.date===i?"today":""}" data-date="${c.date}">
                    ...
                    <div class="event-list">
                        ${c.events.map(l=>{var p;const u=l.userId===((p=kt.currentUser)==null?void 0:p.uid),h=new Date(l.start).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),d=new Date(l.end).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});return`
        ...
        <div class="ad-space"></div>
    `,gs(),document.querySelectorAll(".ad-space").forEach(c=>{c.addEventListener("click",l=>{const u=document.createElement("span");u.classList.add("ripple"),c.appendChild(u);const h=l.clientX-c.getBoundingClientRect().left,d=l.clientY-c.getBoundingClientRect().top;u.style.left=`${h}px`,u.style.top=`${d}px`,setTimeout(()=>u.remove(),600)})}),(r=document.getElementById("logout-btn"))==null||r.addEventListener("click",()=>{Dh(kt),K("Logged out")}),(o=document.getElementById("prev-month"))==null||o.addEventListener("click",()=>{J--,J<0&&(J=11,ht--),vi()}),(a=document.getElementById("next-month"))==null||a.addEventListener("click",()=>{J++,J>11&&(J=0,ht++),vi()}),document.querySelectorAll(".delete-ev-btn").forEach(c=>{c.addEventListener("click",async l=>{var p,_;l.stopPropagation();const u=c.closest(".event"),h=u.getAttribute("data-id"),d=(_=(p=u.querySelector(".event-title"))==null?void 0:p.textContent)==null?void 0:_.replace(" (Me)","");h&&h_(`Delete event "${d}"?`,async()=>{try{await o_(h),K("Event deleted")}catch(I){K(I.message,"error")}})})}),document.querySelectorAll(".day-cell").forEach(c=>{c.addEventListener("click",l=>{const u=document.createElement("span");u.classList.add("ripple"),c.appendChild(u);const h=l.clientX-c.getBoundingClientRect().left,d=l.clientY-c.getBoundingClientRect().top;u.style.left=`${h}px`,u.style.top=`${d}px`,setTimeout(()=>u.remove(),600);const p=c.getAttribute("data-date");p&&u_(p,gi)})});const s=new Date;if(ht===s.getFullYear()&&J===s.getMonth()){const c=s.getFullYear(),l=String(s.getMonth()+1).padStart(2,"0"),u=String(s.getDate()).padStart(2,"0"),h=`${c}-${l}-${u}`,d=document.querySelector(`.day-cell[data-date="${h}"]`);d&&setTimeout(()=>{d.scrollIntoView({behavior:"smooth",block:"center"}),d.style.boxShadow="0 0 20px #00ffff",setTimeout(()=>{d.style.boxShadow=""},2e3)},100)}}Oh(kt,n=>{n?s_(e=>{gi=e,vi()}):l_()});
